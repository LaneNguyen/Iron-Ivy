Shader "AllIn13DShader - Baked Effects/Squireel"
{
	Properties
	{
	...
	SubShader
	{
				...
				Pass
		{
			...
			#include "../../../Shaders/ShaderLibrary/AllIn13DShader_FeaturesURP_Defines.hlsl"
			#include_with_pragmas "../../../Shaders/ShaderLibrary/AllIn13DShader_FeaturesURP.hlsl"
			...
			//<ALLIN1_EFFECTS>
			#define _LIGHTMODEL_CLASSIC
#define _SHADINGMODEL_PBR
#define _SPECULARMODEL_CLASSIC
#define _REFLECTIONS_CLASSIC
#define _CAST_SHADOWS_ON
#define _RECEIVE_SHADOWS_ON
#define _RECEIVEDSHADOWSTYPE_CLASSIC

			//</ALLIN1_EFFECTS>
		
			#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Core.hlsl"
			
			#include_with_pragmas "../../../Shaders/ShaderLibrary/AllIn13DShader_Features.hlsl"
			#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/Lighting.hlsl"
			
			#include "../../../Shaders/ShaderLibrary/AllIn13DShader_CommonStructs.hlsl"
			#include "../../../Shaders/ShaderLibrary/AllIn13DShader_CommonFunctions.hlsl"
			#include "../../../Shaders/ShaderLibrary/AllIn13DShaderHelper_URP.hlsl"
			#include "../../../Shaders/ShaderLibrary/AllIn13DShaderLight.hlsl"
			
			#include "../../../Shaders/ShaderLibrary/AllIn13DShaderCore.hlsl"
			#include "../../../Shaders/ShaderLibrary/AllIn13DShader_BasePass.hlsl"
...
#define _RECEIVEDSHADOWSTYPE_CLASSIC
			...
			#include "../../../Shaders/ShaderLibrary/AllIn13DShaderCore.hlsl"
			#include "../../../Shaders/ShaderLibrary/AllIn13DShader_ShadowCasterPass.hlsl"
...
#define _RECEIVEDSHADOWSTYPE_CLASSIC
			...
			#include "../../../Shaders/ShaderLibrary/AllIn13DShaderCore.hlsl"
			#include "../../../Shaders/ShaderLibrary/AllIn13DShader_URP_DepthNormalsPass.hlsl"
...
#define _RECEIVEDSHADOWSTYPE_CLASSIC
			...
			#include "../../../Shaders/ShaderLibrary/AllIn13DShaderCore.hlsl"
			#include "../../../Shaders/ShaderLibrary/AllIn13DShader_URP_DepthOnlyPass.hlsl"
...
#define _RECEIVEDSHADOWSTYPE_CLASSIC
			...
			#include "../../../Shaders/ShaderLibrary/AllIn13DShaderCore.hlsl"
			#include "../../../Shaders/ShaderLibrary/AllIn13DShader_URP_MetaPass.hlsl"
...
#define _RECEIVEDSHADOWSTYPE_CLASSIC
			...
			#include "../../../Shaders/ShaderLibrary/AllIn13DShader_CommonStructs.hlsl"
			#include "../../../Shaders/ShaderLibrary/AllIn13DShader_CommonFunctions.hlsl"
			#include "../../../Shaders/ShaderLibrary/AllIn13DShaderHelper_BIRP.hlsl"
			#include "../../../Shaders/ShaderLibrary/AllIn13DShaderLight.hlsl"
...
#define _RECEIVEDSHADOWSTYPE_CLASSIC
			...
			#include "../../../Shaders/ShaderLibrary/AllIn13DShaderCore.hlsl"
			#include "../../../Shaders/ShaderLibrary/AllIn13DShaderLightAddPass.hlsl"
